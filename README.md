# Защита веб-приложения. WAF для блокировки вредоносных запросов.  IDS/IPS на базе Suricata для обнаружения сетевых аномалий. Монитоинг на базе Promtail/Loki/Grafana.#
...
Из-за ограниченных ресурсов придется контролировать контейнеры по ресурсам.
